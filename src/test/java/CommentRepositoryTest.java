...
class CommentRepositoryTest extends BaseRepositoryTest {
    ...
    void create_ShouldSaveCommentByUser() {
        Account user = new Account("comment_user@example.com", "password123", Account.AccountType.USER);
    ...
    void create_ShouldSaveCommentByAdmin() {
        Account admin = new Account("admin_comment@example.com", "adminpassword123", Account.AccountType.ADMIN);
    ...
    void getById_ShouldReturnComment() {
        Account user = new Account("comment_user2@example.com", "password123", Account.AccountType.USER);
        accountRepository.create(user);
    ...
    void getAll_ShouldReturnListOfComments() {
        Account user = new Account("comment_user3@example.com", "password123", Account.AccountType.USER);
        accountRepository.create(user);

        Account admin = new Account("admin_user3@example.com", "adminpassword123", Account.AccountType.ADMIN);
        accountRepository.create(admin);
    ...
    void update_ShouldUpdateCommentByUser() {
        Account user = new Account("comment_user4@example.com", "password123", Account.AccountType.USER);
        accountRepository.create(user);
    ...
    void delete_ShouldDeleteCommentByUser() {
        Account user = new Account("comment_user5@example.com", "password123", Account.AccountType.USER);
        accountRepository.create(user);
    ...
    void delete_ShouldDeleteCommentByAdmin() {
        Account admin = new Account("admin_user5@example.com", "adminpassword123", Account.AccountType.ADMIN);
        accountRepository.create(admin);
